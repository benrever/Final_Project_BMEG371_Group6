...
mutation.patients$Cluster <- ifelse(mutation.patients$Hugo_Symbol == "TP53", 1,
...
patient_clusters <- aggregate(Cluster ~ Patient_ID, data = mutation.patients, FUN = function(x) x[1])
...
clinical.data$Cluster[is.na(clinical.data$Cluster)] <- "Other"
