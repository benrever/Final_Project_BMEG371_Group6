...
ggsurvplot(fit, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35, legend.labs = c("Stage: I", "Stage: II", "Stage: III", "Stage: IV", "Stage: X"))
```
...
ggsurvplot(fit_race, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35)
```
...
ggsurvplot(fit_subtype, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35, legend.labs = c("BRCA_Basal", "BRCA_Her2", "BRCA_LumA", "BRCA_LumB", "BRCA_Normal"))
```

```{r}
#Lymph Node Survival 
clin_df[which(clin_df$PRIMARY_LYMPH_NODE_PRESENTATION_ASSESSMENT == ""), "PRIMARY_LYMPH_NODE_PRESENTATION_ASSESSMENT"] = NA
...
fit_lymph$strata
ggsurvplot(fit_lymph, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35, legend.labs = c("No Lymph Presenation", "Lymph Presentation"))
```
...
ggsurvplot(fit_status, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35,legend.labs = c("Tumor Free", "With Tumor"))
```
...
ggsurvplot(fit_treat, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35)
```
...
ggsurvplot(fit_new, data=clin_df, pval=T, risk.table=T, risk.table.col="strata", risk.table.height=0.35,legend.labs = c("No new tumor", "New Tumor after treatment"))
```
...
ggsurvplot(fit_comb, data=clin_df, pval=T, legend = "bottom",legend.labs = c("TF: Basal", "TF: Her2", "TF: LumA","TF: LumB","TF: Normal","WT: Basal", "WT: Her2", "WT: LumA","WT: LumB","WT: Normal"))
```
